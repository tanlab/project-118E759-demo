...
def decode_stereo(smiles2D):
    ...
    dec_isomers = [Chem.MolFromSmiles(Chem.MolToSmiles(mol, isomericSmiles=False)) for mol in dec_isomers]
    smiles3D = [Chem.MolToSmiles(mol, isomericSmiles=False) for mol in dec_isomers]
    ...
    if len(chiralN) > 0:
        for mol in dec_isomers:
            ...
            smiles3D.append(Chem.MolToSmiles(mol, isomericSmiles=False))
